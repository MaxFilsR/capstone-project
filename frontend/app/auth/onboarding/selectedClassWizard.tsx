/**
 * Selected Class Wizard Screen
 *
 * Confirmation screen showing Wizard class details after workout style selection.
 */
...
export default function selectedClassWizard() {
    return (
        <ScrollView
                ...
                >
                    ...
                    <View style={{ padding: 16, paddingVertical: 12 }}>
                        ...
                        <Text style={[typography.body, { color: "#DADADA" }]}>
                            Swift and relentless. Specializes in endurance
                            training, running, and outdoor cardio.
                        </Text>
                    </View>
