...
const myRoutines: Routine[] = [
  ...
  { id: "my_routine_2", name: "Back and Biceps", summary: "Deadlift • Seated Row • Lat Pulldown • Bicep Curl" },
];
  ...
  return (
    <View style={{ position: "relative" }}>
      <View style={styles.card}>
        ...
        <Ionicons name="chevron-forward" size={18} color={colorPallet.neutral_lightest} />
      </View>

      <Pressable style={styles.cardOverlay} hitSlop={10} onPress={() => onOpen(routine)} />
    </View>
  );
}
...
const RoutinesScreen = () => {
  ...
  return (
    <ScrollView style={tabStyles.tabContent} contentContainerStyle={{ paddingBottom: 100}}>
      {/* My Routines */}
      <Text style={[typography.h2, styles.sectionTitle]}>My Routines</Text>
      ...
      {/* Pre-made Routines */}
      <Text style={[typography.h2, styles.sectionTitle]}>Pre-made Routines</Text>
      <View style={{ gap: 12 }}>
